# Build Across Directories

add_subdirectory lets each source folder own part of a larger build.

## Mission
Connect the top-level project to lib/ and app/ CMakeLists files.

# Complete a Tiny Receiver

Complete the receiver: mix -1500 Hz, average each 8-sample symbol, decide real>0 as bit 0, pack bits MSB-first, and write decoded ASCII to `answer.txt`.
